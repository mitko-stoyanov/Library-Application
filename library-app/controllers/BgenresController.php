...
use app\models\BgenresSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * BgenresController implements the CRUD actions for BookGenres model.
 */
class BgenresController extends Controller
{
    /**
     * @inheritDoc
     */
